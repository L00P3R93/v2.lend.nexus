...
@section('title')
    <title>Products | Lend.Nexus</title>
@endsection
                        ...
                        <table id="productsTable" class="table table-bordered table-striped table-hover">
                            ...
                            @foreach($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        <a class="mr-3" href="{{ url('/products/edit/'.$product->id) }}">
...
@section('script')
    ...
    <script>
        const productsTable = $("#productsTable").DataTable({
            ...
            buttons: [
                {text: '<i class=\'fas fa-plus-circle\'></i> New Product', className: 'btn btn-sm bg-gradient-navy text-white',
                    action: function () {
                        window.open('products/create', '_self')
                    }
                },
                "colvis"
            ],
