...
@section('title')
    <title>New Customer | Lend.Nexus</title>
@endsection
                            ...
                            <div class="row m-t-10">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="idNo" id="idNo" placeholder="National ID/Passport" required autocomplete="off" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row m-t-10">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" name="work_email" id="work_email" placeholder="Email Address" required autocomplete="off"  />
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                            ...
                            <div class="row m-t-10">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" name="loan_limit" id="loan_limit" placeholder="Loan Limit" />
                                    </div>
